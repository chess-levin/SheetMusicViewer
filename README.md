...
Unter den Releases ist die aktuelle Version zu finden. Das zip-File enthält eine vollständig eigenständige Version mit dem .NET Framework. Ist das Framework schon vorhanden kann die andere Version ausgeführt werden. Sollte .NET fehlen oder nicht passen, wird es beim Starten nachinstalliert.
